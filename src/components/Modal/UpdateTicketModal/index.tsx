...
import classes from './UpdateTicketModal.module.css';
    ...
    return (
        <Modal>
            <div className={classes.addBox}>
                <h1>Cập nhập thông tin gói vé</h1>
                <div className={classes.nameEvent}>
                    <div>
                        <label htmlFor="nameTicket">Mã sự kiện <span style={{ color: '#FD5959' }}>*</span></label>
                        <input type="text" placeholder="Mã gói vé" />
                    </div>
                    <div>
                        <label htmlFor="nameTicket">Tên sự kiện <span style={{ color: '#FD5959' }}>*</span></label>
                        <input type="text" placeholder="Mã gói vé" />
                    </div>
                </div>
